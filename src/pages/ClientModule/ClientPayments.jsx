...
import {
  ...
  downloadTextFile,
  formatDateShortLabel as formatDateLabel,
  formatTimeLabel,
...
import TransactionsList from "../../components/clientPayments/TransactionsHistory";

export default function ClientPayments() {
  const [walletBalance, setWalletBalance] = useState(2450.8);
  const [savedMethods, setSavedMethods] = useState(savedPaymentMethodsData);
    ...
    setTransactions((previousTransactions) => [
      {
        ...
        invoiceLabel:
          "INV-WD-" + String(previousTransactions.length + 1).padStart(3, "0"),
  ...
  return (
    <div className="w-full max-w-full overflow-x-hidden text-white">
      <div className="mx-auto w-full max-w-[1280px]">
        ...
        <div className="grid w-full grid-cols-1 gap-6 xl:grid-cols-[320px_minmax(0,1fr)]">
