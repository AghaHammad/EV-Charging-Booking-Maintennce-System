  ...
  return (
    <div className="mt-8 rounded-[34px] border border-white/6 bg-[linear-gradient(180deg,rgba(16,42,56,0.96),rgba(12,34,46,0.98))] p-6 shadow-[0_18px_40px_rgba(0,0,0,0.18)]">
      <div className="flex items-start justify-between gap-4">
        <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-[#10483f]/45">
          <WalletCards className="h-6 w-6 text-[#35d3a4]" />
        </div>

        <span className="rounded-full bg-[#19d6a8]/10 px-3 py-1 text-[11px] font-semibold text-[#35d3a4]">
          {activeWalletStatusText}
        </span>
      </div>

      <p className="mt-5 text-[15px] text-white/58">Total Wallet Balance</p>
