...
export const SIDEBAR_LINKS = [
  ...
  { name: "Stations", path: "/client/stations" },
  { name: "Bookings", path: "/client/bookings" },
  { name: "Payments", path: "/client/payments" },
  { name: "Maintenance", path: "/client/maintenance" },
...
export const DASHBOARD_MAP_STATIONS = [
  {
    id: 1,
...
export const DASHBOARD_POPULAR_STATIONS = [
  {
    id: 1,
...
export const DASHBOARD_VEHICLE_HEALTH = [
  {
    id: 1,
    label: "Tire Pressure",
    value: "Optimal",
...
export const STATIONS_RECENT_TRIPS = [
  {
    id: 1,
    title: "Airport FastCharge",
...
export const APPOINTMENTS_PER_PAGE = 5;
